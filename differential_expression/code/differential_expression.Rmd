...
cat ../../../predicted_genes/common_genes1.txt | while read gene;
do
...
do
  ...
  awk '!/^>/ { printf "%s", $0; n = "\n" } /^>/ { print n $0; n = "" } END { printf "%s", n }' ${gene}.fltrd.fa > ${gene}.fltr.fa 
  rm ${gene}.fltrd.fa
  rm ${gene}.clstr.srtd
  rm ${gene}.unfltrd.fa
  rm ${gene}.unfltr.fa
...
do
  ...
  do
    ...
    grep -f gene.txt -A 1 $file >> ../final_transcrtips/${lineage}.fa
    done
  rm gene.txt
  rm ${gene}.fltr.fa
done
